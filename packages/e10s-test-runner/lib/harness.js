// This is a modification of test-harness's harness.js. We'll ultimately 
// need to fold these changes into that original file.
...
function nextIteration(tests) {
  ...
  if (iterationsLeft)
    sandbox.require("e10s-unit-test").findAndRunTests({dirs: dirs,
                                                       filter: filter,
